 ...
 * preferred-database tiles, the dynamic-form inputs, the SQLAlchemy URI form,
 * the submit button, and the form-item validation errors used by the
 * migrated Cypress modal spec.
 */
