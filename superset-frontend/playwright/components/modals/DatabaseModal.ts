...
export class DatabaseModal extends Modal {
  ...
  /**
   * Gets a dynamic-form input by its `name` attribute (e.g. "host", "port",
  ...
  /**
   * Gets the database-name input on the SQLAlchemy form.
   */
  ...
  /**
   * Gets the SQLAlchemy URI input on the SQLAlchemy form.
   */
  ...
  /**
   * Gets the submit/connect button.
   */
  ...
  /**
   * Gets a form error message locator filtered by text content.
   */
