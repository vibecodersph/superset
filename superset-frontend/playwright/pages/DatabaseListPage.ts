...
/**
 * Page object for the Database list / "Connect a database" page
 * (`/databaseview/list/`).
 *
 * The list itself is covered by `Table` / `BulkSelect` helpers in other tests
 * — this page object only exposes the entry point used by the connect-modal
 * test (the "+ Database" button).
 */
