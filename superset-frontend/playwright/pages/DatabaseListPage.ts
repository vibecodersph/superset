 ...
 *
 * Wraps the database list page rendered at `/databaseview/list/` by
...
export class DatabaseListPage {
  ...
  /**
   * Returns the "+ Database" button used to open the connection modal.
   */
  ...
  /**
   * Waits for the create-database button to be visible (used as the
   * page-ready signal).
