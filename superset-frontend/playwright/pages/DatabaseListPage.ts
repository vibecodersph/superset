...
/**
 * Page object for the Database list (`/databaseview/list`).
 *
 * Exposes the minimum surface needed by the "Add database" modal tests:
 * navigation and a click on the "+ Database" button that opens the
...
export class DatabaseListPage {
  ...
  async clickAddDatabase(): Promise<void> {
    await this.page
      .locator(DatabaseListPage.SELECTORS.ADD_DATABASE_BUTTON)
      .click();
  }
}
